...
//Encryption operation
    ...
    public String login(String username, String password) {
        String token = null;
//Cryptography requires client-side encryption
        try {
...
//the original encryption is the same without modification
            admin.setPassword(null);
        } else {
//the original encryption is different to the need to modify encryption
...
//first discipation of the original
...
//Insert +-limit system
    ...
    /**
     * Transforming +- permission relationships into objects
     */
