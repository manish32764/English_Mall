...
/**
 * Coupon Management Service Implementation Class
...
//Insert coupon and product system table
...
//Insert coupon and product distribution system table
...
//Eliminating the product subdivision link
...
//Exclude the insertion of coupons and product system table
        if (couponParam.getUseType().equals(2)) {
            for (SmsCouponProductRelation productRelation : couponParam.getProductRelationList()) {
                productRelation.setCouponId(couponParam.getId());
            }
...
//Exclude the insertion of coupons and product distribution system table
        if (couponParam.getUseType().equals(1)) {
            for (SmsCouponProductCategoryRelation couponProductCategoryRelation : couponParam.getProductCategoryRelationList()) {
                couponProductCategoryRelation.setCouponId(couponParam.getId());
            }
