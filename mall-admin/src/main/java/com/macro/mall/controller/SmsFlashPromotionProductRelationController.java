...
/**
 * Limited Time Purchase and Relationship Management Controller
 * Created by macro on 2018/11/16.
 */
@Controller
@Api(tags = "SmsFlashPromotionProductRelationController", description = "Limited time purchase and relationship management")
@RequestMapping("/flashProductRelation")
public class SmsFlashPromotionProductRelationController {
    @Autowired
    private SmsFlashPromotionProductRelationService relationService;

    @ApiOperation("Add association by selecting products in bulk")
    ...
    @ApiOperation("Modify Correlation Related Information")
    ...
    @ApiOperation("Get Manage Product Promotions")
    ...
    @ApiOperation("Check the links and product information by page")
