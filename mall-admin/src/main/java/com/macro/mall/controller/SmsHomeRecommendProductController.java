...
/**
 * Home Top Recommended Management Controller
 * Created by macro on 2018/11/6.
 */
@Controller
@Api(tags = "SmsHomeenhProductController", description = "Home Popularity Recommended Administration")
@RequestMapping("/home/recommendProduct")
public class SmsHomeRecommendProductController {
    @Autowired
    private SmsHomeRecommendProductService recommendProductService;

    @ApiOperation("Add home page recommendation")
