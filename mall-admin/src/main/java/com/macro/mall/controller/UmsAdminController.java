...
public class UmsAdminController {
    ...
    @ApiOperation(value = "Logout feature")
    ...
    @ApiOperation("Get User List by User Name or Name")
    ...
    @ApiOperation("Get specified user information")
    ...
    @ApiOperation("Modify specified user password")
    ...
    public CommonResult updatePassword(@RequestBody UpdateAdminPasswordParam updatePasswordParam) {
        ...
        if (status > 0) {
            ...
            return CommonResult.failed("CommonResult.failed to submit parameters");
        } else if (status == -2) {
            return CommonResult.failed("This user could not be found");
        } else if (status == -3) {
    ...
    @ApiOperation("Assign +- Permissions to Users")
