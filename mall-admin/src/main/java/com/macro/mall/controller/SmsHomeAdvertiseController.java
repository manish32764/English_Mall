...
/**
 * Home Rotary Manager Controller
 * Created by macro on 2018/11/7.
 */
@Controller
@Api(tags = "SmsHomeAdvertiseController", description = "Home Rotary Manager")
...
public class SmsHomeAdvertiseController {
    ...
    @ApiOperation("pagination lookup ads")
