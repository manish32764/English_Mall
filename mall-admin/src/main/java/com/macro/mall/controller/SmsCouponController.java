 ...
 */
@Controller
@Api(tags = "SmsCouponController", description = "Coupon Management")
...
public class SmsCouponController {
    ...
    @ApiOperation("Get Coupon List by Coupon Name and Type")
    ...
    @ApiOperation("Get details for a single coupon")
