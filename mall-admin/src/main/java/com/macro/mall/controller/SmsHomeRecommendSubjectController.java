...
/**
 * Home Thematic Recommended Management Controller
 * Created by macro on 2018/11/6.
 */
@Controller
@Api(tags = "SmsHomeAddSubjectController", description = "Home topic Recommended Administration")
@RequestMapping("/home/recommendSubject")
public class SmsHomeRecommendSubjectController {
    @Autowired
    private SmsHomeRecommendSubjectService recommendSubjectService;

    @ApiOperation("Add Home Recommended Themes")
    ...
    @ApiOperation("Bulk Delete Recommended")
    ...
    @ApiOperation("Bulk Modify Referred Status")
    ...
    @ApiOperation("pagination recommendation")
