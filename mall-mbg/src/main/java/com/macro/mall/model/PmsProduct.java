...
public class PmsProduct implements Serializable {
    ...
    @ApiModelProperty(value = "shelf status: 0-> drop off; 1-> shelf")
    private Integer publishStatus;
    @ApiModelProperty(value = "New Status: 0-> Not New; 1-> New")
    private Integer newStatus;
    @ApiModelProperty(value = "Recommended Status; 0-> Not Recommended; 1-> Recommended")
    private Integer recommandStatus;
    @ApiModelProperty(value = "Review Status: 0-> Unapproved; 1-> Approval Passed")
    ...
    @ApiModelProperty(value = "given growth value")
    private Integer giftGrowth;
    @ApiModelProperty(value = "gift points")
    private Integer giftPoint;
    @ApiModelProperty(value = "Limit number of points used")
    ...
    @ApiModelProperty(value = "Inventory Alert Value")
    private Integer lowStock;
    @ApiModelProperty(value = "Units")
    private String unit;
    @ApiModelProperty(value = "Item weight, default to grams")
    private BigDecimal weight;
    @ApiModelProperty(value = "Tentor item: 0-> No; 1-> Yes")
    private Integer previewStatus;
    @ApiModelProperty(value = "Comma-separated products and services: 1-> hassle free returns; 2-> quick refunds; 3-> free shipping")
    private String serviceIds;
    private String keywords;
    private String note;
    @ApiModelProperty(value = "Picture album images, limited to 5 photos, separated by commas")
    ...
    @ApiModelProperty(value = "Campaign Limit Quantity")
    private Integer promotionPerLimit;
    @ApiModelProperty(value = "Promotion Type: 0-> No Promotion Use Original Price; 1-> Use Promotional Price; 2-> Use Member Price; 3-> Use Ladder price; 4-> use full discount price; 5-> limited time purchase")
    ...
    @ApiModelProperty(value = "Mobile Page Details")
