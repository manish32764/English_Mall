...
public class OmsOrderSetting implements Serializable {
    ...
    private Long id;
    @ApiModelProperty(value = "Deal timeout close (minutes)")
    private Integer flashOrderOvertime;
    @ApiModelProperty(value = "Normal order timeout (minutes)")
    private Integer normalOrderOvertime;
    @ApiModelProperty(value = "Automatic receipt confirmation after shipment (days)")
    private Integer confirmOvertime;
    @ApiModelProperty(value = "Auto completion time, not available after sales (days)")
    private Integer finishOvertime;
    @ApiModelProperty(value = "Auto positive time (days) after order completion")
