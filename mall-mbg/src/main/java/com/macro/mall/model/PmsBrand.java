...
public class PmsBrand implements Serializable {
    ...
    private Long id;
    private String name;
    @ApiModelProperty(value = "initial letter")
    private String firstLetter;
    private Integer sort;
    @ApiModelProperty(value = "Brand Manufacturer: 0-> No; 1-> Yes")
    private Integer factoryStatus;
    private Integer showStatus;
    @ApiModelProperty(value = "Product Quantity")
    private Integer productCount;
    @ApiModelProperty(value = "Product Reviews Quantity")
    private Integer productCommentCount;
    @ApiModelProperty(value = "brand logo")
    private String logo;
    @ApiModelProperty(value = "large area map")
