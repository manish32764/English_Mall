...
public class PmsComment implements Serializable {
    ...
    @ApiModelProperty(value = "Star rating: 0->5")
    private Integer star;
    @ApiModelProperty(value = "evaluated ip")
    private String memberIp;
    private Date createTime;
    private Integer showStatus;
    @ApiModelProperty(value = "Item attribute at time of purchase")
    private String productAttribute;
    private Integer collectCouont;
    private Integer readCount;
    @ApiModelProperty(value = "Upload image addresses separated by commas")
    private String pics;
    @ApiModelProperty(value = "Comment user avatar")
