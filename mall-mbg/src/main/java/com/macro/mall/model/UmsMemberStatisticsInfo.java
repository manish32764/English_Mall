...
public class UmsMemberStatisticsInfo implements Serializable {
    ...
    @ApiModelProperty(value = "Accumulated spending amount")
    private BigDecimal consumeAmount;
    @ApiModelProperty(value = "order quantity")
    private Integer orderCount;
    @ApiModelProperty(value = "Coupon Quantity")
    private Integer couponCount;
    @ApiModelProperty(value = "number of evaluations")
    private Integer commentCount;
    @ApiModelProperty(value = "Return Quantity")
    private Integer returnOrderCount;
    @ApiModelProperty(value = "Login Count")
    private Integer loginCount;
    @ApiModelProperty(value = "quantity of attention")
    private Integer attendCount;
    @ApiModelProperty(value = "Number of fans")
    ...
    @ApiModelProperty(value = "Last order was place")
