...
public class OmsOrder implements Serializable {
    ...
    @ApiModelProperty(value = "Amount due (actual amount paid)")
    private BigDecimal payAmount;
    @ApiModelProperty(value = "Shipping Amount")
    private BigDecimal freightAmount;
    @ApiModelProperty(value = "Promotional Optimization Amount (Promotional Price, Full Reduction, Ladder Price)")
    private BigDecimal promotionAmount;
    @ApiModelProperty(value = "Credits Amount")
    private BigDecimal integrationAmount;
    @ApiModelProperty(value = "coupon credit amount")
    private BigDecimal couponAmount;
    @ApiModelProperty(value = "Admin background adjusted discount amount used for orders")
    ...
    @ApiModelProperty(value = "Logistics Company (Shipping Method)")
    private String deliveryCompany;
    @ApiModelProperty(value = "Logistics Number")
    private String deliverySn;
    @ApiModelProperty(value = "auto-confirm time (days)")
    private Integer autoConfirmDay;
    @ApiModelProperty(value = "Points you can earn")
    private Integer integration;
    @ApiModelProperty(value = "growth value that can be active")
    ...
    @ApiModelProperty(value = "Recipient Mailbox")
    ...
    private String note;
    @ApiModelProperty(value = "Confirm Receipt Status: 0-> Unconfirmed; 1-> Confirmation")
    private Integer confirmStatus;
    @ApiModelProperty(value = "Deletion Status: 0-> Not Deleted; 1-> Deleted")
    private Integer deleteStatus;
    @ApiModelProperty(value = "Points used to place an order")
    private Integer useIntegration;
    @ApiModelProperty(value = "Payment Time")
    private Date paymentTime;
    @ApiModelProperty(value = "Ship Time")
    private Date deliveryTime;
    @ApiModelProperty(value = "Receipt Confirmation")
