...
public class OmsOrderItem implements Serializable {
    ...
    @ApiModelProperty(value = "Product promotion split amount")
    private BigDecimal promotionAmount;
    @ApiModelProperty(value = "Coupon Discount Amount")
    private BigDecimal couponAmount;
    @ApiModelProperty(value = "credit split amount")
    private BigDecimal integrationAmount;
    @ApiModelProperty(value = "The split amount of this item after the promotion")
    private BigDecimal realAmount;
    private Integer giftIntegration;
    private Integer giftGrowth;
    @ApiModelProperty(value = "Product sales attribute: [{'key': 'color', 'value': 'color'}, {'key': 'Capacity ',' value ':' 4G '}]")
