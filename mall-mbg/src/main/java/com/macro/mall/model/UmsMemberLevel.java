...
public class UmsMemberLevel implements Serializable {
    ...
    @ApiModelProperty(value = "Default rating: 0-> not; 1-> Yes")
    private Integer defaultStatus;
    @ApiModelProperty(value = "Free Shipping Standard")
    private BigDecimal freeFreightPoint;
    @ApiModelProperty(value = "growth value acquired per evaluation")
    private Integer commentGrowthPoint;
    @ApiModelProperty(value = "Do you have free shipping privileges")
    private Integer priviledgeFreeFreight;
    @ApiModelProperty(value = "check in privilege")
    private Integer priviledgeSignIn;
    @ApiModelProperty(value = "Is there a rewarded privilege for comments")
    private Integer priviledgeComment;
    @ApiModelProperty(value = "Do you have exclusive event privileges")
    private Integer priviledgePromotion;
    @ApiModelProperty(value = "Member Price privilege")
    private Integer priviledgeMemberPrice;
    @ApiModelProperty(value = "birthday privilege")
